...
export default function CommercialMenu() {
        ...
        >
            ...
            >
                ...
                <div className="flex md:flex-0 lg:mr-5">
                    <Link href="/commercial" className="-m-1.5 p-1.5">
                ...
                <div className="hidden lg:flex lg:gap-x-2">
                    <Link href="/howCommercial" className="button-container py-1 px-3">
                        How We Work
                    </Link>
                    <Link href="/pestCommercial" className="button-container py-1 px-3">
                        Pest Library
                    </Link>
                    <Link href="/commercialPayment" className="button-container py-1 px-3">
                        Make A Payment
                    </Link>
                    <div className="relative">
                        ...
                        {isDropdownOpen && (
                            <div className="absolute mt-2 w-48 bg-gray-800 rounded-lg shadow-lg z-20">
                                <Link
                                    href="/testimonialCommercial"
                                    className="block px-4 py-2 text-sm text-white hover:bg-gray-700"
                                >
                                    Testimonials
                                </Link>
                                <Link
                                    href="/storyCommercial"
                                    className="block px-4 py-2 text-sm text-white hover:bg-gray-700"
                                >
                                    Our Story
                                </Link>
            ...
            {isMenuOpen && (
                <div className="lg:hidden bg-gray-800 text-white p-5">
                    <Link href="/howCommercial" className="block py-2 px-4 hover:bg-gray-700">
                        How We Work
                    </Link>
                    <Link href="/pestCommercial" className="block py-2 px-4 hover:bg-gray-700">
                        Pest Library
                    </Link>
                    <Link href="/paymentCommercial" className="block py-2 px-4 hover:bg-gray-700">
                        Make a Payment
                    </Link>
                    <button
                        onClick={toggleDropdown}
