                ...
                <div className="row">
                    ...
                    <div className="col-md-4 text-center">
                        ...
                        <ul className="list-unstyled">
                            <li><a href="/freequote" className="text-white text-decoration-none">Free Quote</a></li>
                            ...
                            <li><a href="/pestlibrary" className="text-white text-decoration-none">Pest Library</a></li>
                        </ul>
                    </div>
